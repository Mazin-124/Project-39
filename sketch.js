...
function setup() {
  ...
  mario = createSprite(1000,displayHeight-350,20,50);
  mario.addAnimation("running", mario_running);
  mario.scale = 0.5;
  //mario.debug=true;  
  
  ground = createSprite(displayWidth/2 ,displayHeight-300,displayWidth*2,10);
...
function spawnCoin() {
  ...
  if (frameCount % 60 === 0) {
    ...
    coin.y = Math.round(random(1500,120));
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(displayWidth-600,displayHeight-330,10,40);    
